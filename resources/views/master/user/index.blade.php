                                            ...
                                            <table class="table table-striped gy-7 gs-7">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('edit.user', $item->id ) }}" class="btn btn-sm btn-primary btn-action" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                                            <form id="form-delete" action="{{ route('destroy.user', $item->id ) }}" method="POST"
                                                            ...
                                                            <a href="{{ route('reset.user', $item->id ) }}" class="btn btn-sm btn-warning btn-action" data-toggle="tooltip" title="Reset"><i class="fas fa-sync"></i></a>
                                                        </td>
                                                    </tr>
                                                    @php
