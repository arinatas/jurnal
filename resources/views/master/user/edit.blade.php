                        ...
                        <div class="mt-15">
                            <form action="{{ route('update.user', $user->id ) }}" method="POST">
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="text" value="{{$user->username}}" class="form-control form-control-solid" required name="username"/>
                                </div>
								<div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">Nama</label>
                                    <input type="text" value="{{$user->nama}}" class="form-control form-control-solid" required name="nama"/>
                                </div>
								<div class="mb-10">
									...
									<select class="form-select form-select-solid" name="is_aktif" required>
										<option value="0" {{$user->is_aktif == 0 ? 'selected' : ''}}>Nonaktif</option>
										<option value="1" {{$user->is_aktif == 1 ? 'selected' : ''}}>Aktif</option>
									</select>
								</div>
