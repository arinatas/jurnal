                                            ...
                                            <table class="table table-striped gy-7 gs-7">
                                                <thead>
                                                    <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                                                        ...
                                                        <th class="min-w-100px">Jenis Uang</th>
                                                        <th class="min-w-100px">Pecahan</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{ $no }}</td>
                                                        <td>
                                                            @if ($item->jenis_uang == 0)
                                                            <span class="badge bg-secondary text-dark">Logam</span>
                                                            @elseif($item->jenis_uang == 1)
                                                            <span class="badge bg-success">Kertas</span>
                                                            @endif
                                                        </td>
                                                        <td>Rp. @currency($item->pecahan)</td>
                                                        <td>
                                                            @if ($item->status == 0)
                                                        ...
                                                        <td>
                                                            <a href="{{ route('edit.pecahan', $item->id ) }}" class="btn btn-sm btn-primary btn-action" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                                            <form id="form-delete" action="{{ route('destroy.pecahan', $item->id ) }}" method="POST"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                <!--begin::Form-->
                                                <form action="{{ route('insert.pecahan') }}" method="POST">
                                                    @csrf
                                                    <!--begin::Input group-->
                                                    <div class="d-flex flex-column mb-7 fv-row">
                                                        <!--begin::Label-->
                                                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                            <span class="required">Jenis Pecahan</span>
                                                        </label>
                                                        <!--end::Label-->
                                                        <select class="form-select form-select-solid" required data-control="select2" data-hide-search="true" data-placeholder="Pilih Jenis Uang" name="jenis_uang">
                                                            <option value="">Pilih Jenis Uang</option>
                                                            <option value="1">Kertas</option>
                                                            <option value="0">Logam</option>
                                                        </select>
                                                    </div>
                                                    <div class="d-flex flex-column mb-7 fv-row">
                                                        <!--begin::Label-->
                                                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                            <span class="required">Nominal Pecahan</span>
                                                        </label>
                                                        <!--end::Label-->
                                                        <input class="form-control form-control-solid" oninput="formatCurrency(this)" type="text" name="pecahan" required value=""/>
                                                    </div>
                                                    <div class="d-flex flex-column mb-7 fv-row">
                                                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                        ...
                                                        <!--end::Label-->
                                                        <select class="form-select form-select-solid" required data-control="select2" data-hide-search="true" data-placeholder="Pilih Status" name="status">
