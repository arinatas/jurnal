                                    ...
                                    <div class="card-body pb-5">
                                        ...
                                        <div class="card-px pt-10 d-flex justify-content-between">
                                            <!--begin::Title-->
                                                ...
                                                <div class="d-inline">
                                                    <a href="{{ route('input.jurnal') }}" class="btn btn-sm btn-primary fs-6">Input Jurnal</a>
                                        ...
                                        <div class="card-px mt-10">                                            
                                            <form action="{{ route('jurnal') }}" method="GET">
                                                <div class="row mb-3">
                                                    <div class="col-md-3">
                                            ...
                                            <table class="table table-striped gy-7 gs-7">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @else
                                                            <!-- <a href="{{ route('edit.jurnal', $item->id ) }}" class="btn btn-sm btn-primary btn-action" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a> -->
                                                            <a href="{{ route('edit.jurnal', ['id' => $item->id, 'start_date' => $start_date, 'end_date' => $end_date]) }}" class="btn btn-sm btn-primary btn-action" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                                            <form id="form-delete" action="{{ route('destroy.jurnal', $item->id ) }}" method="POST"
