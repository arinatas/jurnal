                                    ...
                                    <div class="card-body pb-5">
                                        ...
                                        <div class="card-px pt-10 d-flex justify-content-between">
                                            ...
                                            <div class="d-inline">
                                                ...
                                                <a href="{{ route('exportBukuBesarAll', ['selectedYear' => request('tahun'), 'selectedMonth' => request('bulan'), 'selectedDivisi' => request('divisi'), 'selectedJurnalAccount' => request('jurnal_akun')]) }}" class="btn btn-sm btn-info" title="Export Excel">Export Excel</a>
                                            </div>
                                            ...
                                            <div class="d-inline">
                                                ...
                                                <a href="{{ route('exportBukuBesarJurnal', ['selectedYear' => request('tahun'), 'selectedMonth' => request('bulan'), 'selectedJurnalAccount' => request('jurnal_akun')]) }}" class="btn btn-sm btn-info" title="Export Excel">Export Excel</a>
                                            </div>
