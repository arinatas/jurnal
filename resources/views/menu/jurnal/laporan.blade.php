                                            ...
                                            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
                                                ...
                                                <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                                    ...
                                                    <div class="mb-3 mb-md-0 fw-bold">
                                                        <h4 class="text-gray-900 fw-bolder">Silakan filter terlebih dahulu berdasarkan tanggal awal & tanggal akhir </h4>
                                                        <div class="fs-6 text-gray-700 pe-7">Pilih Bulan & Tahun pada formulir di atas untuk melihatdata.</div>
                                                    </div>
                                                    <!--end::Content-->
                                                </div>
                                                <!--end::Wrapper-->
