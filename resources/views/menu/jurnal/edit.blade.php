                        ...
                        <div class="mt-15">
                            <form action="{{ route('update.jurnal', $jurnal->id ) }}" method="POST">
								...
								<div class="mb-10">
                                    ...
                                    <input type="date" value="{{$jurnal->periode_jurnal}}" class="form-control form-control-solid" required name="periode_jurnal"/>
                                </div>
								<div class="mb-10">
									...
									<select class="form-select form-select-solid" required data-control="select2" data-hide-search="true" data-placeholder="Pilih Type Jurnal" name="type_jurnal">
										...
										<option value="ju" {{$jurnal->type_jurnal == "ju" ? 'selected' : ''}}>Jurnal Umum</option>
										<option value="jp" {{$jurnal->type_jurnal == "jp" ? 'selected' : ''}}>Jurnal Penyesuaian</option>
									</select>
                                </div>
								<div class="mb-10">
									...
									<select class="form-select form-control-solid" name="divisi" required>
										...
										@foreach($divisions as $division)
											<option value="{{$division->id}}" {{$jurnal->divisi == $division->id ? 'selected' : ''}}>{{$division->nama_divisi}}</option>
										@endforeach
									</select>
								</div>
								<div class="mb-10">
									...
									<select class="form-select form-control-solid" name="kode_akun" required>
										...
										@foreach($jurnalAkuns as $jurnalAkun)
											<option value="{{$jurnalAkun->no_akun}}" {{$jurnal->kode_akun == $jurnalAkun->no_akun ? 'selected' : ''}}>{{$jurnalAkun->no_akun}} - {{$jurnalAkun->nama_akun}}</option>
										@endforeach
									</select>
								</div>
								<div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">Uraian</label>
                                    <input type="text" value="{{$jurnal->uraian}}" class="form-control form-control-solid" required name="uraian"/>
                                </div>
								<div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">No Bukti</label>
                                    <input type="text" value="{{$jurnal->no_bukti}}" class="form-control form-control-solid" required name="no_bukti"/>
                                </div>
								<div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">Debit</label>
                                    <input type="text" value="{{$jurnal->debit}}" class="form-control form-control-solid" required name="debit"/>
                                </div>
								<div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">Kredit</label>
                                    <input type="text" value="{{$jurnal->kredit}}" class="form-control form-control-solid" required name="kredit"/>
                                </div>
								<div class="mb-10">
                                    <label for="exampleFormControlInput1" class="required form-label">Keterangan RKAT</label>
                                    <input type="text" value="{{$jurnal->keterangan_rkat}}" class="form-control form-control-solid" required name="keterangan_rkat"/>
                                </div>
