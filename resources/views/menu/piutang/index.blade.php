                                            ...
                                            <table class="table table-striped gy-7 gs-7">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($item->stts_reallisasi == 1)
                                                                Aktif
                                                            @elseif ($item->stts_reallisasi == 0)
                                                                Nonaktif
                                                            @endif
                                                        </td>
                                                        <td>
                                                            ...
                                                            <a href="" class="btn btn-sm btn-warning btn-action" data-toggle="tooltip" title="Reset"><i class="fas fa-sync"></i></a>
                                                        </td>
                                                    </tr>
                                                    @php
