                                    ...
                                    <div class="card-body pb-5">
                                        ...
                                        <div class="card-px pt-10 d-flex justify-content-between">
                                            <!--begin::Title-->
                                                ...
                                                <div class="d-inline">
                                                    <a href="{{ route('input.kasKeluar') }}" class="btn btn-sm btn-primary fs-6">Input Kas Keluar</a>
                                        ...
                                        <div class="card-px mt-10">                                            
                                            <form action="{{ route('kasKeluar') }}" method="GET">
                                                <div class="row mb-3">
                                                    <div class="col-md-3">
                                        ...
                                        <div class="card-px mt-10 mt-5">
                                            ...
                                            <form action="{{ route('import.kasKeluar') }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div class="mb-3">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @else
                                                            ...
                                                            <a href="{{ route('edit.kasKeluar', ['id' => $item->id, 'start_date' => $start_date, 'end_date' => $end_date]) }}" class="btn btn-sm btn-primary btn-action" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
